<?php
// derzhava_api/scientist_training_jobs_get.php
// Получить все задания обучения учёных (botan) для правителя
...
$stmt = $pdo->prepare('SELECT * FROM scientist_training_jobs WHERE ruler_name = ?');
$stmt->execute([$ruler]);
$rows = $stmt->fetchAll();
