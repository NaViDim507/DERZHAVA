<?php
// derzhava_api/research_jobs_get.php
// Получить все задания исследований для правителя
...
$stmt = $pdo->prepare('SELECT * FROM research_jobs WHERE ruler_name = ?');
$stmt->execute([$ruler]);
$rows = $stmt->fetchAll();
